...
export const DIRECTORS_STATEMENT_INTERNAL_CONTROL: StatutoryStatement = {
  ...
  paragraphs: [
    ...
    "Ð Various appointed committees are",
    ...
    "Ð The Internal Audit Department of",
    ...
    "Ð The BAC reviews internal control",
    ...
    "Ð Operational committees have also",
    ...
    "Ð In assessing the internal control",
...
export const CEO_AND_CFO_RESPONSIBILITY_STATEMENT: StatutoryStatement = {
  ...
  paragraphs: [
    ...
    "Ð Sri Lanka Accounting Standards",
    "issued by The Institute of Chartered Accountants of Sri Lanka (CA Sri Lanka)",
    "Ð Companies Act No. 07 of 2007 and",
    "amendments thereto;",
    "Ð Sri Lanka Accounting and Auditing",
    "Standards Act No. 15 of 1995 and amendments thereto;",
    "Ð Banking Act No. 30 of 1988 and",
    "amendments thereto;",
    "Ð Directions, Determinations, Orders,",
    "Circulars and Guidelines issued by the Central Bank of Sri Lanka (CBSL),",
    "Ð Listing Rules of the Colombo Stock",
    "Exchange.",
    "Ð Code of Best Practice on Corporate",
    "Governance issued by the Institute of Chartered Accountants of Sri Lanka; and",
    "Ð Section 9.2 (b) of the Banking Act",
    ...
    "Ð The Bank has complied with all",
    "applicable laws, regulations and prudential requirements;",
    "Ð There are no material non-",
    "compliances; and",
    "Ð There are no material litigations that",
...
export const INDEPENDENT_AUDITORS_REPORT_EY = {
  ...
  paragraphs: [
    ...
    "Ð Assessed the alignment of the Bank's allowances for",
    ...
    "Ð Evaluated the design, implementation and operating",
    "effectiveness of controls over estimation of expected credit losses.",
    "Ð Assessed the level of oversight, review and approval",
    ...
    "Ð Checked the completeness, accuracy and reasonableness",
    ...
    "Ð Evaluated the reasonableness of credit quality assessments",
    "and related stage classifications",
    "Ð In addition to the above, the following procedures were",
    "performed:",
    "For loans and advances assessed on an individual basis for impairment:",
    "Ð Checked the arithmetical accuracy of the underlying",
    "individual impairment calculations.",
    "Ð Evaluated the reasonableness of key inputs used in the",
    ...
    "Ð Tested the key inputs and the calculations used in the",
    "allowances for expected credit losses.",
    "Ð Assessed the reasonableness of judgements, assumptions",
    ...
    "Ð Our testing included evaluating the reasonableness of",
    ...
    "Ð Evaluate the appropriateness of",
    "accounting policies used and the reasonableness of accounting",
    "estimates and related disclosures made by management.",
    "Ð Conclude on the appropriateness",
    ...
    "Ð Evaluate the overall presentation,",
