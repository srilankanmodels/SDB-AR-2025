...
# Load all 7 committee raw texts and build the TypeScript file
birmc_sections = [
    {
...
all_committees = [
    {
        ...
        "members": [
            { "name": "Mr. Prasanna Premaratna", "role": "Chairman", "designation": "Independent Non-Executive Director (Appointed Chairman w.e.f. 10.12.2025)" },
            { "name": "Ms. Dinithi Ratnayake", "role": "Member", "designation": "Chairperson of the Board / Independent Non-Executive Director" },
            { "name": "Mr. Conrad Dias", "role": "Member", "designation": "Non-Independent Non-Executive Director" },
            { "name": "Mr. Chandana Dissanayake", "role": "Member", "designation": "Independent Non-Executive Director (Appointed Member 10.12.2025)" },
            { "name": "Mr. Dinuke Wijesinghe", "role": "Chief Risk Officer", "designation": "Key Management Personnel (By Invitation)" },
            { "name": "Mr. Kapila Ariyaratne", "role": "Executive Member", "designation": "Executive Director / CEO (By Invitation)" }
        ],
        "meetingsHeld": 5,
    ...
    },
    {
        ...
        "attendance": [
            { "name": "Mr. Chaaminda Kumarasiri", "attended": 12, "eligible": 12 },
            { "name": "Mr. Prasanna Premaratna", "attended": 11, "eligible": 12 },
            { "name": "Mr. Thusantha Wijemanna", "attended": 12, "eligible": 12 }
        ],
        "fullReportSections": bac_sections,
        "signOff": {
    ...
    },
    {
        ...
        "members": [
            { "name": "Mr. Thusantha Wijemanna", "role": "Chairman", "designation": "Independent Non-Executive Director (Appointed Chairman 10.12.2025)" },
            { "name": "Mr. Prasanna Premaratna", "role": "Member", "designation": "Independent Non-Executive Director" },
        ...
        "attendance": [
            { "name": "Mr. Thusantha Wijemanna", "attended": 6, "eligible": 6 },
            { "name": "Mr. Prasanna Premaratna", "attended": 6, "eligible": 6 },
            { "name": "Mr. Sarath Nandasiri", "attended": 5, "eligible": 6 },
            { "name": "Mr. Chandana Dissanayake", "attended": 6, "eligible": 6 }
        ],
        "fullReportSections": bhrrc_sections,
        "signOff": {
    ...
    },
    {
        ...
        "attendance": [
            { "name": "Mr. Thusantha Wijemanna", "attended": 5, "eligible": 5 },
            { "name": "Ms. Dinithi Ratnayake", "attended": 5, "eligible": 5 },
            { "name": "Mr. Chaaminda Kumarasiri", "attended": 5, "eligible": 5 },
            { "name": "Mr. Conrad Dias", "attended": 5, "eligible": 5 }
        ],
        "fullReportSections": bsngc_sections,
        "signOff": {
            "signedBy": "Mr. Thusantha Wijemanna",
    ...
    },
    {
        ...
        "attendance": [
            ...
            { "name": "Mr. Chandana Dissanayake", "attended": 4, "eligible": 4 }
        ],
        "fullReportSections": brptrc_sections,
        "signOff": {
            "signedBy": "Mr. Thusantha Wijemanna",
    ...
    },
    {
        ...
        "members": [
            { "name": "Mr. Chandana Dissanayake", "role": "Chairman", "designation": "Independent Non-Executive Director (Appointed Chairman 10.12.2025)" },
            { "name": "Ms. Dinithi Ratnayake", "role": "Member", "designation": "Chairperson of the Board / Independent Non-Executive Director" },
            { "name": "Mr. Conrad Dias", "role": "Member", "designation": "Non-Independent Non-Executive Director" },
        ...
        "attendance": [
            { "name": "Mr. Chandana Dissanayake", "attended": 5, "eligible": 5 },
            { "name": "Ms. Dinithi Ratnayake", "attended": 5, "eligible": 5 },
            { "name": "Mr. Conrad Dias", "attended": 5, "eligible": 5 },
            { "name": "Mr. Romani De Silva", "attended": 5, "eligible": 5 },
            { "name": "Mr. Kapila Ariyaratne", "attended": 5, "eligible": 5 }
        ],
        "fullReportSections": bspc_sections,
        "signOff": {
    ...
    },
    {
        ...
        "chairperson": "Mr. Chandana Dissanayake (Independent, Non-Executive Director)",
        "members": [
            { "name": "Mr. Chandana Dissanayake", "role": "Chairman", "designation": "Independent Non-Executive Director (Appointed Chairman w.e.f. 10.12.2025)" },
            { "name": "Mr. Romani De Silva", "role": "Member", "designation": "Non-Independent Non-Executive Director" },
            { "name": "Mr. Thusantha Wijemanna", "role": "Member", "designation": "Independent Non-Executive Director" },
            { "name": "Mr. Prasanna Premaratna", "role": "Member", "designation": "Independent Non-Executive Director" },
        ...
        "attendance": [
            { "name": "Mr. Chandana Dissanayake", "attended": 9, "eligible": 9 },
            { "name": "Mr. Romani De Silva", "attended": 9, "eligible": 9 },
            { "name": "Mr. Thusantha Wijemanna", "attended": 9, "eligible": 9 },
            { "name": "Mr. Prasanna Premaratna", "attended": 8, "eligible": 9 },
            { "name": "Mr. Kapila Ariyaratne", "attended": 9, "eligible": 9 }
        ],
        "fullReportSections": bcc_sections,
        "signOff": {
            "signedBy": "Mr. Chandana Dissanayake",
...
# Read rest of governanceData.ts
with open("src/data/governanceData.ts", "r", encoding="utf-8") as f:
    orig = f.read()

# Header and Chairperson Statement
header_part = """/**
 * @license
...
committees_part = "export const BOARD_COMMITTEES_DETAILED: CommitteeReport[] = " + json.dumps(all_committees, indent=2, ensure_ascii=False) + ";\n\n"

# Find Point 26: Financial Calendar
idx_cal = orig.find("// Point 26: Financial Calendar")
rest_part = orig[idx_cal:]

final_content = header_part + "\n" + committees_part + rest_part

with open("src/data/governanceData.ts", "w", encoding="utf-8") as f:
    f.write(final_content)

print("Updated src/data/governanceData.ts with all 7 complete Board Committee Reports!")
